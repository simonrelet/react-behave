...
[![npm version next](https://img.shields.io/npm/v/react-behave/next.svg?colorB=blue&style=flat-square)](https://www.npmjs.com/package/react-behave/v/1.0.0-alpha.7)
...
[See lastest release](https://github.com/simonrelet/react-behave/tree/1.0.0-alpha.7).
...
The documentation of each component can be found [here](https://github.com/simonrelet/react-behave/tree/1.0.0-alpha.7/docs).
